...
do
  echo $i threads
  python exp_tpcc_single_run.py --ab=/home/Norman.Rzepka/tpcc/queries_gen/20W_1M.txt --clients=1000 --threads=$i --abCore=22 --port=5222 --tabledir=/home/Norman.Rzepka/tpcc/20W-tables/ --duration=60 --verbose=1 --stdout --stderr
