...
python exp_tpcc_generate_queries.py --tabledir=$HOME/tpcc/1W-tables/ --genCount=10000000 --genFile=$HOME/tpcc/queries_gen/1W_1M.txt --warehouses=1 --duration=10000 --port=9090
python exp_tpcc_generate_queries.py --tabledir=$HOME/tpcc/10W-tables/ --genCount=10000000 --genFile=$HOME/tpcc/queries_gen/10W_1M.txt --warehouses=10 --duration=10000 --port=9091
